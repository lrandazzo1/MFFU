...
Some of what you are looking at is real. Most of it is not. The difference is
almost always the same, and it is not subtle once you know where to look.
...
outcomes. Somebody chose them. They will keep choosing them until they have a
reason not to.
...
The hardest roster call in September is the talented player whose usage says
something his box score does not.

This is where target share earns its reputation. A receiver commanding a real
share of a competent passing game is the most durable thing in this format,
because it survives bad weeks. **Puka Nacua** is the archetype: the value is in
how often the ball is thrown at him, not in what any single Sunday did with it.
If the share is there, sit on it. Volume regresses toward production far more
reliably than production regresses toward volume.
...
Do not evaluate tight ends on the same clock as everyone else.
...
1. Sort your roster by snap share, not by points. Look at the gap between the
...
The teams that win leagues in September are not the ones that made the most
moves. They are the ones that correctly did nothing four times and then moved
hard on the fifth.
