/* ============================================================
   ...
   Location: lib/ (not api/) so Vercel does not count this helper against the
   serverless function limit; it is required from the two handlers by relative
   path and never routed to on its own.
