...
--------------------------------------------------------------------------- */
{
  ...
  check('payload omits fantasy league routing state', Object.hasOwn(a.data, 'leagueId'), false);

  const anotherLeague = E.buildNotification('waiver_pivot', {
    leagueId: 'a-completely-different-league', seasonYear: 2026, week: 3,
  });
  check('public-news copy does not vary by fantasy league', anotherLeague, a);
