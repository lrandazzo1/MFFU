...
function fixture() {
  return sleeperSnapshot({league_id:'123',season:'2026',settings:{leg:2}},[
    ...
    {transaction_id:'ok',status:'complete',type:'waiver',status_updated:now-1000,leg:2,adds:{2:1},settings:{waiver_bid:0},waiver_budget:[{amount:15,sender:2,receiver:1}]},
