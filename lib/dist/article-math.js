...
function normalizeEntry(entry, week) {
    if (!entry)
        return null;
    ...
    const kickoff = kickoffMs(entry.kickoff != null ? entry.kickoff :
...
function normalizeSide(side, week) {
    if (!side)
        return null;
...
function normalizeMatchups(leagueBoxScores, week) {
