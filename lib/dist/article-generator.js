...
exports.defaultComposer = exports.OUTCOME_FRAMING_RULE = exports.ARTICLE_TYPE_BY_DAY = void 0;
...
async function generateAndPublishBlogArticle(input, dependencies = {}) {
    ...
    const evaluated = (0, article_math_1.calculatePlayerOutcomeFlags)(boxScores, { week: scope.week });
